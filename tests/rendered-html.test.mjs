...
test("ships colored pixel assets, animated zombies, audio, weapons, and mobile controls", async () => {
  ...
  assert.match(core, /EnemyKind = "thug" \| "runner" \| "brute" \| "thrower" \| "walker" \| "kitty" \| "kittyBoss" \| "neonWarden" \| "ironTitan" \| "wardenBoss" \| "sirenBoss"/);
  assert.match(core, /enemy\.kind === "sirenBoss" \? "sonic" : enemy\.kind === "thrower" \? "thrown" : enemy\.kind === "neonWarden" \? "neonOrb" : "labubu"/);
  ...
  assert.match(core, /bossCycle === 10 \? "neonWarden"/);
  assert.match(core, /bossCycle === 15 \? "ironTitan"/);
  ...
  assert.match(core, /state\.waveSpawnCount === 0/);
  assert.match(core, /bossCycle === 5 \? "kittyBoss"/);
  ...
  assert.match(game, /function drawBossHud/);
  assert.match(game, /function drawOriginalBoss/);
  assert.match(game, /function drawBossArenaDepth/);
